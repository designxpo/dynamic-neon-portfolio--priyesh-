    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="admin-card">
                ...
                <div className="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows={3} value={formData.description || ''} onChange={handleChange} className="admin-textarea" placeholder="Contact section description..." />
                    </div>
            ...
            <div className="admin-card">
                ...
                <button type="button" onClick={(e) => { e.preventDefault(); e.stopPropagation(); addSocialLink(); }} className="admin-button-secondary mt-4 flex items-center gap-2">
                    <Plus size={18} />
                    Add Social Link
                </button>
            </div>
